...
*/ -}}
{{- define "k8s-daemonset.daemonsetSpec" -}}
{{- /*
...
kind: DaemonSet
metadata:
  name: {{ include "k8s-daemonset.fullname" . }}{{ if .isCanary }}-canary{{ end }}
  labels:
    # These labels are required by helm. You can read more about required labels in the chart best practices guide:
    # https://docs.helm.sh/chart_best_practices/#standard-labels
    helm.sh/chart: {{ include "k8s-daemonset.chart" . }}
    app.kubernetes.io/name: {{ include "k8s-daemonset.name" . }}
          ...
          configMap:
            ...
            items:
              ...
              - key: {{ $configKey }}
                ...
                mode: {{ include "k8s-daemonset.fileModeOctalToDecimal" $keyMountConfig.fileMode }}
                {{- end }}
              {{- end }}
            {{- end }}
      {{- end }}
